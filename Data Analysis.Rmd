...
```{r}
files<- list.files("/Users/wyatttheking/Desktop/Spring 2025/Politics in the Lab/FINISHED GAMES")
paths<- paste0("/Users/wyatttheking/Desktop/Spring 2025/Politics in the Lab/FINISHED GAMES/", files)
paths<-paths[c(2, 6:13, 3:5)]
```
...
for(i in seq_along(paths)){
  df<- data.frame()
  for(j in 3:23){
    excel<- read_xlsx(paths[i], sheet=j, range = "B3:G7")
    excel<- excel %>%
...
player_assignments<- read.csv("/Users/wyatttheking/Desktop/Spring 2025/Politics in the Lab/Player Assignment - Static Sheet.csv")
...
```{r}
write_path<- paste0("/Users/wyatttheking/Desktop/Spring 2025/Politics in the Lab/FINISHED GAMES/Uncleaned Data.csv")
...
```{r}
write_path<- paste0("/Users/wyatttheking/Desktop/Spring 2025/Politics in the Lab/FINISHED GAMES/Cleaned Data.csv")
...
m1<-glm(y_play~Round+Game+pi_allocation+oi_allocation, family="binomial", data=reg_data)
sum_m1<-summary(m1)
...
even_plays_by_round$Equilibrium<- c(0.626, 0.632, 0.667, 1)
